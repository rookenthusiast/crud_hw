...
-- SELECT * FROM movies;  question_1
-- SELECT name FROM people; question_2
-- SELECT 'Cameron Fulton' FROM people; question_3
-- DELETE FROM movies WHERE title = 'Batman Begins'; question_4
-- INSERT INTO people (name) VALUES ('Steveee'); question_5
-- DELETE FROM people WHERE name = 'Graeme Bell'; question_6
-- UPDATE people SET name = 'Jeff 3' WHERE name = 'Adam Leel';
-- UPDATE people SET name = 'Jeff 3.2' WHERE name = 'Adam Nattrass'; question_7
-- INSERT INTO movies (title, year, show_time) VALUES ('Guardians of the Galaxy 2', 2017, '00:00'); question_8
